...
rm -rf %{payload_dir}
tar -xf %{SOURCE1}
echo "b08b5a85546b875ed83dc0836f0f541f18a4a7a51064b3c24022bdd50631af78  %{_sourcedir}/Grok_Bot_0.56.1_linux_arm64.tar.gz" | sha256sum -c -
cd %{payload_dir}
%else
rm -rf %{payload_dir}
tar -xf %{SOURCE0}
echo "0d1667f56a5afbd8e1b9b1fdacf7da1981d2dabe9b5e5f27d256cc994849d91c  %{_sourcedir}/Grok_Bot_0.56.1_linux_x64.tar.gz" | sha256sum -c -
cd %{payload_dir}
%endif
...
%changelog
* Fri Sep 18 2026 Nichokas <nichokas@users.noreply.github.com> - 0.56.1-1
- Sync with upstream release v0.56.1 (x64 sha256 0d1667f56a5afbd8e1b9b1fdacf7da1981d2dabe9b5e5f27d256cc994849d91c) (arm64 sha256 b08b5a85546b875ed83dc0836f0f541f18a4a7a51064b3c24022bdd50631af78).

* Thu Sep 17 2026 Nichokas <nichokas@users.noreply.github.com> - 0.55.0-1
- Sync with upstream release v0.55.0 (x64 sha256 26dcd282f161f12c6de38360e3afa3252ee2973e8bc37d2951fbabe93063eab7) (arm64 sha256 3a1c6751c62670b3c3d516f97cdf8a01d283b1b33edef8161ff68d8201bcc6b0).

* Wed Sep 16 2026 Nichokas <nichokas@users.noreply.github.com> - 0.53.0-1
- Sync with upstream release v0.53.0 (x64 sha256 e0a8a94fa6170e0a50a912ac255d1f81b77602225bddb3d536749c10108fdc64) (arm64 sha256 7901f93db8be0a895d38f60ba320b4c65ab7ae395f197e901ec6ef09f667d919).

* Tue Sep 15 2026 Nichokas <nichokas@users.noreply.github.com> - 0.51.0-1
- Sync with upstream release v0.51.0 (x64 sha256 a2628513205ee98c428f8e5da18e942b5d4242e0065464882a3898223c2cf804) (arm64 sha256 cc72f17aa07e2e59867356bdbaad11b87a688bca24c058f1f9e02bce778df324).

* Thu Sep 10 2026 Nichokas <nichokas@users.noreply.github.com> - 0.47.0-1
- Sync with upstream release v0.47.0 (x64 sha256 7e3dbba93f044d1ef91cd9fe3590a1f298a92ec829b44eab205e2dfa40c2e994) (arm64 sha256 3d71ca11e78c59f407aab8052431ad145879844c99a5d94b2e7123f4998e7173).
